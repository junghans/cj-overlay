...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/k3b/k3b-2.0.0.ebuild,v 1.3 2010/07/29 19:13:20 hwoarang Exp $
...
IUSE="debug dvd emovix encode ffmpeg flac hal mad lame musepack musicbrainz sndfile sox taglib vcd vorbis +wav"
...
src_configure() {
	mycmakeargs+=( "-DK3B_BUILD_K3BSETUP=OFF"
		...
		$(cmake-utils_use hal K3B_BUILD_HAL_SUPPORT)
