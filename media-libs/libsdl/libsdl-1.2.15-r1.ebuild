...
IUSE="oss alsa alsa-shared nas X dga xv xinerama fbcon directfb ggi svga tslib aalib opengl libcaca +audio +video +joystick custom-cflags pulseaudio pulseaudio-shared ps3 static-libs"
